...
function SelectAppointment() {
  ...
  const bookProfessional = (appointment, doctor) => {
    navigate("/bookAppointment", { state: { appointment, doctor } });
  };
  ...
  const getDoctors = async (e) => {
    ...
    const allDoctors = await myContract.methods
    ...
    console.log("Add doctors: ", doctorList);
  };
  ...
  console.log(
    "Functions: getAllMedicalProfessionals, getAvailableAppointments"
  );
